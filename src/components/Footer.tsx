		...
		<div className="bg-[#0b0d15] z-30 relative">
			...
			>
				<div className="text-white pb-16 pt-[200px]">
					<h2 className="flex justify-center p-2 headline-font md:text-xl bg-stone-900 bg-opacity-95 w-[95%] max-w-[600px] mx-auto rounded-xl rounded-b-none">
				...
				<div className="w-full overflow-hidden flex justify-between p-2 pb-0 text-white headline-font text-xs md:text-base">
					<span className="hover:text-[#c524a8]"></span>
					<span>Radiant Pine &copy; 2026</span>
